...
#exp(
  ...
  details: [
    ...
    - Developed 10+ new features in a complex and mature Java Spring web application as per the needs of users.
    - Collaborated on an ongoing UI refresh for MyInfoVault and transitioned JSP pages to modern technologies such as Vue.js
  ]
)
...
#exp(
  ...
  details: [
    - Worked with a team of fellow interns to build & release a full-stack mobile application to develop an AI processing pipeline in collaboration with the WildMe organization to identify and tag wild horses.
    - Designed and deployed backend systems for image processing, user management, and app functionality using industry standard technologies and platforms such as Microsoft Azure, Google Firebase, and PostgreSQL.
    - Implemented machine learning models into the back-end to ensure image validity and quality whilst removing unwanted \& dangerous content.
